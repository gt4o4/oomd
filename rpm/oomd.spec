...
Version:	0.5.0^118.g88c28fd
Release:	1%{dist}
License:	GPL-2.0-only
URL:		https://github.com/gt4o4/oomd/
Source0:	%{url}/archive/v%{version}/%{name}-%{version}.tar.gz

# Originally from Fedora package: https://src.fedoraproject.org/rpms/oomd
# Adapted for current HEAD (118 commits past v0.5.0)

# Patches 0-2 from the Fedora spec are already merged upstream:
#   076af42 - Check return value for mkstemp()
#   3989e16 - Fix ODR violation in tests
#   83a6742 - Resolved a compiler error due to lacking include

# Disable a test that fails on kernel >= 6.6.9-100.fc38
Patch0:		oomd-disable-datalifecycle-children-test.patch
...
%changelog
* Thu Mar 26 2026 gt4o4 - 0.5.0^118.g88c28fd-1
- Import Fedora spec and adapt for current HEAD
- Drop Patch0-2 (already merged upstream)
- Keep DataLifeCycle test disable patch
